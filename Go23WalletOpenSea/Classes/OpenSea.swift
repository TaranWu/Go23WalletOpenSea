...
public typealias OpenSeaAddressesToNonFungibles = [Go23Wallet.Address: [NftAsset]]
...
public final class BaseOpenSeaNetworkingFactory: OpenSeaNetworkingFactory {
    ...
    private let queue = DispatchQueue(label: "org.Go23Wallet.swift.atomicDictionary", qos: .background)
...
public class OpenSea {
    ...
    public func fetchAssetsCollections(owner: Go23Wallet.Address,
                                       chainId: ChainId,
                                       excludeContracts: [(Go23Wallet.Address, ChainId)]) -> AnyPublisher<Response<OpenSeaAddressesToNonFungibles>, Never> {
        ...
        func findCollection(address: Go23Wallet.Address, asset: NftAsset, collections: [CollectionKey: Go23WalletOpenSea.NftCollection]) -> Go23WalletOpenSea.NftCollection? {
        ...
        return Publishers.CombineLatest(assets, collections)
            .map { assets, collections in
                var result: [Go23Wallet.Address: [NftAsset]] = [:]
    ...
    private func fetchCollections(owner: Go23Wallet.Address,
                                  chainId: ChainId,
                                  offset: Int = 0,
    ...
    private func fetchAssets(owner: Go23Wallet.Address,
                             chainId: ChainId,
                             next: String? = nil,
    ...
    private struct NftAssetsFilter {
        let assets: [Go23Wallet.Address: [NftAsset]]

        func assets(excludeing excludeContracts: [(Go23Wallet.Address, ChainId)]) -> [Go23Wallet.Address: [NftAsset]] {
