...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of Go23WalletOpenSea.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Taran/Go23WalletOpenSea'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Taran' => 'NA' }
  s.source           = { :git => 'https://github.com/Taran/Go23WalletOpenSea.git', :tag => s.version.to_s }
